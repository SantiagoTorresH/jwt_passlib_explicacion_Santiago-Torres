...
# Importamos para manejo de variables de entorno
import os
...
# Si es "*", mantener como lista con asterisco, sino separar por comas
cors_origins = ["*"] if cors_origins_env == "*" else [origin.strip() for origin in cors_origins_env.split(",")]

# Middleware para permitir CORS (Cross-Origin Resource Sharing)
app.add_middleware(
    CORSMiddleware,
    allow_origins=cors_origins,  # Orígenes desde .env (¡configurar en producción!)
